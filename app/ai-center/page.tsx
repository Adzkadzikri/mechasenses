                  ...
                  {predictionResult.mlPrediction ? (
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-sm font-medium text-yellow-800">ML Analysis</p>
                          <p className="text-sm text-yellow-700 mt-1">
                            Advanced predictions are calculated using sensor data analysis
                          </p>
                          <p className="text-xs text-yellow-600 mt-2">
                            Health scores use real-time formula calculations
                          </p>
                        </div>
                      </div>
                    </div>
