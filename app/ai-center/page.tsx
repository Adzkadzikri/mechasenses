                  ...
                  {predictionResult.mlPrediction ? (
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-sm font-medium text-yellow-800">ML Predictions</p>
                          <p className="text-sm text-yellow-700 mt-1">
                            {predictionResult.mlServiceError || 'ML predictions need vibration data to work properly'}
                          </p>
                          <p className="text-xs text-yellow-600 mt-2">
                            Health scores are calculated using sensor data formulas
                          </p>
                        </div>
                      </div>
                    </div>
